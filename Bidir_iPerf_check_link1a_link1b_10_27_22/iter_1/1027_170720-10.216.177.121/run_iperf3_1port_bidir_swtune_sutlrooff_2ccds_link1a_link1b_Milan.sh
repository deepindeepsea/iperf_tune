...
do
    ...
    for f in /sys/class/net/link1a/queues/rx-*/rps_flow_cnt; do echo 1023 >"$f"; done
    ...
    for f in /sys/class/net/link1b/queues/rx-*/rps_flow_cnt; do echo 1023 >"$f"; done
    ...
    ssh -p 22 ${REMOTE_HOST} "for f in /sys/class/net/link1a/queues/rx-*/rps_flow_cnt; do echo 1023 > \$f; done"
    ...
    ssh -p 22 ${REMOTE_HOST} "for f in /sys/class/net/link1b/queues/rx-*/rps_flow_cnt; do echo 1023 > \$f; done"
    ssh -p 22 ${REMOTE_HOST} "/usr/sbin/set_irq_affinity_cpulist.sh \
