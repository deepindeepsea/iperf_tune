...
do
    ...
    numactl -C "$CLIENT_IFACE1_LOCAL_PIN" iperf3 --client ${ip_addr_link1b_remote} --interval 10 --bind ${ip_addr_link1b_local} --time ${RUNTIME} --len=128K --port 25000 -Z >${ip_addr_link1b_local}_local_client_25000.out &
    numactl -C "$CLIENT_IFACE1_LOCAL_PIN" iperf3 --client ${ip_addr_link1b_remote} --interval 10 --bind ${ip_addr_link1b_local} --time ${RUNTIME} --len=128K --port 25001 -Z >${ip_addr_link1b_local}_local_client_25001.out &
    numactl -C "$CLIENT_IFACE1_LOCAL_PIN" iperf3 --client ${ip_addr_link1b_remote} --interval 10 --bind ${ip_addr_link1b_local} --time ${RUNTIME} --len=128K --port 25002 -Z >${ip_addr_link1b_local}_local_client_25002.out &
    numactl -C "$CLIENT_IFACE1_LOCAL_PIN" iperf3 --client ${ip_addr_link1b_remote} --interval 10 --bind ${ip_addr_link1b_local} --time ${RUNTIME} --len=128K --port 25003 -Z >${ip_addr_link1b_local}_local_client_25003.out &
    ...
    numactl -C ${CLIENT_IFACE1_REMOTE_PIN} iperf3 --client ${ip_addr_link1b_local} --interval 10 --bind ${ip_addr_link1b_remote} --time ${RUNTIME} --len=128K --port 25000 -Z >${ip_addr_link1b_remote}_remote_client_25000.out &
    numactl -C ${CLIENT_IFACE1_REMOTE_PIN} iperf3 --client ${ip_addr_link1b_local} --interval 10 --bind ${ip_addr_link1b_remote} --time ${RUNTIME} --len=128K --port 25001 -Z >${ip_addr_link1b_remote}_remote_client_25001.out &
    numactl -C ${CLIENT_IFACE1_REMOTE_PIN} iperf3 --client ${ip_addr_link1b_local} --interval 10 --bind ${ip_addr_link1b_remote} --time ${RUNTIME} --len=128K --port 25002 -Z >${ip_addr_link1b_remote}_remote_client_25002.out &
    numactl -C ${CLIENT_IFACE1_REMOTE_PIN} iperf3 --client ${ip_addr_link1b_local} --interval 10 --bind ${ip_addr_link1b_remote} --time ${RUNTIME} --len=128K --port 25003 -Z >${ip_addr_link1b_remote}_remote_client_25003.out &
