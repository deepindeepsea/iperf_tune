...
do
    ...
    SERVER_IFACE1_LOCAL_PIN="16-31"
    CLIENT_IFACE1_LOCAL_PIN="16-31"
    SERVER_IFACE1_REMOTE_PIN="16-31"
    CLIENT_IFACE1_REMOTE_PIN="16-31"
    ...
    bash /usr/sbin/set_irq_affinity_cpulist.sh "144-159" link1b >/dev/null
    ...
    numactl -C $SERVER_IFACE1_LOCAL_PIN iperf3 --server --bind ${ip_addr_link1b_local} --port 25004 >${ip_addr_link1b_local}_local_server_25004.out &
    numactl -C $SERVER_IFACE1_LOCAL_PIN iperf3 --server --bind ${ip_addr_link1b_local} --port 25005 >${ip_addr_link1b_local}_local_server_25005.out &
    numactl -C $SERVER_IFACE1_LOCAL_PIN iperf3 --server --bind ${ip_addr_link1b_local} --port 25006 >${ip_addr_link1b_local}_local_server_25006.out &
    numactl -C $SERVER_IFACE1_LOCAL_PIN iperf3 --server --bind ${ip_addr_link1b_local} --port 25007 >${ip_addr_link1b_local}_local_server_25007.out &
    ...
    numactl -C $SERVER_IFACE1_REMOTE_PIN iperf3 --server --bind ${ip_addr_link1b_remote} --port 25004 >${ip_addr_link1b_remote}_remote_server_25004.out &
    numactl -C $SERVER_IFACE1_REMOTE_PIN iperf3 --server --bind ${ip_addr_link1b_remote} --port 25005 >${ip_addr_link1b_remote}_remote_server_25005.out &
    numactl -C $SERVER_IFACE1_REMOTE_PIN iperf3 --server --bind ${ip_addr_link1b_remote} --port 25006 >${ip_addr_link1b_remote}_remote_server_25006.out &
    numactl -C $SERVER_IFACE1_REMOTE_PIN iperf3 --server --bind ${ip_addr_link1b_remote} --port 25007 >${ip_addr_link1b_remote}_remote_server_25007.out &
    '" &
    sleep 5
    ...
    numactl -C "$CLIENT_IFACE1_LOCAL_PIN" iperf3 --client ${ip_addr_link1b_remote} --interval 10 --bind ${ip_addr_link1b_local} --time ${RUNTIME} --len=128K --port 25004 -Z >${ip_addr_link1b_local}_local_client_25004.out &
    numactl -C "$CLIENT_IFACE1_LOCAL_PIN" iperf3 --client ${ip_addr_link1b_remote} --interval 10 --bind ${ip_addr_link1b_local} --time ${RUNTIME} --len=128K --port 25005 -Z >${ip_addr_link1b_local}_local_client_25005.out &
    numactl -C "$CLIENT_IFACE1_LOCAL_PIN" iperf3 --client ${ip_addr_link1b_remote} --interval 10 --bind ${ip_addr_link1b_local} --time ${RUNTIME} --len=128K --port 25006 -Z >${ip_addr_link1b_local}_local_client_25006.out &
    numactl -C "$CLIENT_IFACE1_LOCAL_PIN" iperf3 --client ${ip_addr_link1b_remote} --interval 10 --bind ${ip_addr_link1b_local} --time ${RUNTIME} --len=128K --port 25007 -Z >${ip_addr_link1b_local}_local_client_25007.out &
    ...
    numactl -C ${CLIENT_IFACE1_REMOTE_PIN} iperf3 --client ${ip_addr_link1b_local} --interval 10 --bind ${ip_addr_link1b_remote} --time ${RUNTIME} --len=128K --port 25004 -Z >${ip_addr_link1b_remote}_remote_client_25004.out &
    numactl -C ${CLIENT_IFACE1_REMOTE_PIN} iperf3 --client ${ip_addr_link1b_local} --interval 10 --bind ${ip_addr_link1b_remote} --time ${RUNTIME} --len=128K --port 25005 -Z >${ip_addr_link1b_remote}_remote_client_25005.out &
    numactl -C ${CLIENT_IFACE1_REMOTE_PIN} iperf3 --client ${ip_addr_link1b_local} --interval 10 --bind ${ip_addr_link1b_remote} --time ${RUNTIME} --len=128K --port 25006 -Z >${ip_addr_link1b_remote}_remote_client_25006.out &
    numactl -C ${CLIENT_IFACE1_REMOTE_PIN} iperf3 --client ${ip_addr_link1b_local} --interval 10 --bind ${ip_addr_link1b_remote} --time ${RUNTIME} --len=128K --port 25007 -Z >${ip_addr_link1b_remote}_remote_client_25007.out &
    '" &
