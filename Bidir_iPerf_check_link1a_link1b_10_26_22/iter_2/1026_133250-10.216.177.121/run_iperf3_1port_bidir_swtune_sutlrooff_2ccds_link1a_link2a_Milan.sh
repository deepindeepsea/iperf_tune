...
do
    ...
    OUTPUT_DIR=./Bidir_iPerf_check_link1a_link1b_10_26_22/iter_${i}/${PREFIX}
    ...
    #Iperf pinning
    # Forwared direction
    SERVER_IFACE0_LOCAL_PIN="0-15"
    CLIENT_IFACE0_LOCAL_PIN="0-15"
    SERVER_IFACE0_REMOTE_PIN="0-15"
    CLIENT_IFACE0_REMOTE_PIN="0-15"
    ...
    bash /usr/sbin/set_irq_affinity_cpulist.sh "128-143" link1a >/dev/null
    ...
    bash /usr/sbin/set_irq_affinity_cpulist.sh "192-207" link1b >/dev/null
    ...
    #numactl -C $SERVER_IFACE0_LOCAL_PIN iperf3 --server --bind ${ip_addr_link1a_local} --port 25004 >${ip_addr_link1a_local}_local_server_25004.out &
    #numactl -C $SERVER_IFACE0_LOCAL_PIN iperf3 --server --bind ${ip_addr_link1a_local} --port 25005 >${ip_addr_link1a_local}_local_server_25005.out &
    #numactl -C $SERVER_IFACE0_LOCAL_PIN iperf3 --server --bind ${ip_addr_link1a_local} --port 25006 >${ip_addr_link1a_local}_local_server_25006.out &
    #numactl -C $SERVER_IFACE0_LOCAL_PIN iperf3 --server --bind ${ip_addr_link1a_local} --port 25007 >${ip_addr_link1a_local}_local_server_25007.out &
    ...
    #numactl -C $SERVER_IFACE0_REMOTE_PIN iperf3 --server --bind ${ip_addr_link1a_remote} --port 25004 >${ip_addr_link1a_remote}_remote_server_25004.out &
    #numactl -C $SERVER_IFACE0_REMOTE_PIN iperf3 --server --bind ${ip_addr_link1a_remote} --port 25005 >${ip_addr_link1a_remote}_remote_server_25005.out &
    #numactl -C $SERVER_IFACE0_REMOTE_PIN iperf3 --server --bind ${ip_addr_link1a_remote} --port 25006 >${ip_addr_link1a_remote}_remote_server_25006.out &
    #numactl -C $SERVER_IFACE0_REMOTE_PIN iperf3 --server --bind ${ip_addr_link1a_remote} --port 25007 >${ip_addr_link1a_remote}_remote_server_25007.out &
    
    numactl -C $SERVER_IFACE0_REMOTE_PIN iperf3 --server --bind ${ip_addr_link1b_remote} --port 25000 >${ip_addr_link1b_remote}_remote_server_25000.out &
    numactl -C $SERVER_IFACE0_REMOTE_PIN iperf3 --server --bind ${ip_addr_link1b_remote} --port 25001 >${ip_addr_link1b_remote}_remote_server_25001.out &
    numactl -C $SERVER_IFACE0_REMOTE_PIN iperf3 --server --bind ${ip_addr_link1b_remote} --port 25002 >${ip_addr_link1b_remote}_remote_server_25002.out &
    numactl -C $SERVER_IFACE0_REMOTE_PIN iperf3 --server --bind ${ip_addr_link1b_remote} --port 25003 >${ip_addr_link1b_remote}_remote_server_25003.out &
    #numactl -C $SERVER_IFACE0_REMOTE_PIN iperf3 --server --bind ${ip_addr_link1b_remote} --port 25004 >${ip_addr_link1b_remote}_remote_server_25004.out &
    #numactl -C $SERVER_IFACE0_REMOTE_PIN iperf3 --server --bind ${ip_addr_link1b_remote} --port 25005 >${ip_addr_link1b_remote}_remote_server_25005.out &
    #numactl -C $SERVER_IFACE0_REMOTE_PIN iperf3 --server --bind ${ip_addr_link1b_remote} --port 25006 >${ip_addr_link1b_remote}_remote_server_25006.out &
    #numactl -C $SERVER_IFACE0_REMOTE_PIN iperf3 --server --bind ${ip_addr_link1b_remote} --port 25007 >${ip_addr_link1b_remote}_remote_server_25007.out &
    '" &
    sleep 5
    ...
    numactl -C "$CLIENT_IFACE0_LOCAL_PIN" iperf3 --client ${ip_addr_link1b_remote} --interval 10 --bind ${ip_addr_link1b_local} --time ${RUNTIME} --len=128K --port 25000 -Z >${ip_addr_link1b_local}_local_client_25000.out &
    numactl -C "$CLIENT_IFACE0_LOCAL_PIN" iperf3 --client ${ip_addr_link1b_remote} --interval 10 --bind ${ip_addr_link1b_local} --time ${RUNTIME} --len=128K --port 25001 -Z >${ip_addr_link1b_local}_local_client_25001.out &
    numactl -C "$CLIENT_IFACE0_LOCAL_PIN" iperf3 --client ${ip_addr_link1b_remote} --interval 10 --bind ${ip_addr_link1b_local} --time ${RUNTIME} --len=128K --port 25002 -Z >${ip_addr_link1b_local}_local_client_25002.out &
    numactl -C "$CLIENT_IFACE0_LOCAL_PIN" iperf3 --client ${ip_addr_link1b_remote} --interval 10 --bind ${ip_addr_link1b_local} --time ${RUNTIME} --len=128K --port 25003 -Z >${ip_addr_link1b_local}_local_client_25003.out &
    #numactl -C "$CLIENT_IFACE0_LOCAL_PIN" iperf3 --client ${ip_addr_link1b_remote} --interval 10 --bind ${ip_addr_link1b_local} --time ${RUNTIME} --len=128K --port 25004 -Z >${ip_addr_link1b_local}_local_client_25004.out &
    #numactl -C "$CLIENT_IFACE0_LOCAL_PIN" iperf3 --client ${ip_addr_link1b_remote} --interval 10 --bind ${ip_addr_link1b_local} --time ${RUNTIME} --len=128K --port 25005 -Z >${ip_addr_link1b_local}_local_client_25005.out &
    #numactl -C "$CLIENT_IFACE0_LOCAL_PIN" iperf3 --client ${ip_addr_link1b_remote} --interval 10 --bind ${ip_addr_link1b_local} --time ${RUNTIME} --len=128K --port 25006 -Z >${ip_addr_link1b_local}_local_client_25006.out &
    #numactl -C "$CLIENT_IFACE0_LOCAL_PIN" iperf3 --client ${ip_addr_link1b_remote} --interval 10 --bind ${ip_addr_link1b_local} --time ${RUNTIME} --len=128K --port 25007 -Z >${ip_addr_link1b_local}_local_client_25007.out &
    ...
    #numactl -C ${CLIENT_IFACE0_REMOTE_PIN} iperf3 --client ${ip_addr_link1a_local} --interval 10 --bind ${ip_addr_link1a_remote} --time ${RUNTIME} --len=128K --port 25004 -Z >${ip_addr_link1a_remote}_remote_client_25004.out &
    #numactl -C ${CLIENT_IFACE0_REMOTE_PIN} iperf3 --client ${ip_addr_link1a_local} --interval 10 --bind ${ip_addr_link1a_remote} --time ${RUNTIME} --len=128K --port 25005 -Z >${ip_addr_link1a_remote}_remote_client_25005.out &
    #numactl -C ${CLIENT_IFACE0_REMOTE_PIN} iperf3 --client ${ip_addr_link1a_local} --interval 10 --bind ${ip_addr_link1a_remote} --time ${RUNTIME} --len=128K --port 25006 -Z >${ip_addr_link1a_remote}_remote_client_25006.out &
    #numactl -C ${CLIENT_IFACE0_REMOTE_PIN} iperf3 --client ${ip_addr_link1a_local} --interval 10 --bind ${ip_addr_link1a_remote} --time ${RUNTIME} --len=128K --port 25007 -Z >${ip_addr_link1a_remote}_remote_client_25007.out &

    numactl -C ${CLIENT_IFACE0_REMOTE_PIN} iperf3 --client ${ip_addr_link1b_local} --interval 10 --bind ${ip_addr_link1b_remote} --time ${RUNTIME} --len=128K --port 25000 -Z >${ip_addr_link1b_remote}_remote_client_25000.out &
    numactl -C ${CLIENT_IFACE0_REMOTE_PIN} iperf3 --client ${ip_addr_link1b_local} --interval 10 --bind ${ip_addr_link1b_remote} --time ${RUNTIME} --len=128K --port 25001 -Z >${ip_addr_link1b_remote}_remote_client_25001.out &
    numactl -C ${CLIENT_IFACE0_REMOTE_PIN} iperf3 --client ${ip_addr_link1b_local} --interval 10 --bind ${ip_addr_link1b_remote} --time ${RUNTIME} --len=128K --port 25002 -Z >${ip_addr_link1b_remote}_remote_client_25002.out &
    numactl -C ${CLIENT_IFACE0_REMOTE_PIN} iperf3 --client ${ip_addr_link1b_local} --interval 10 --bind ${ip_addr_link1b_remote} --time ${RUNTIME} --len=128K --port 25003 -Z >${ip_addr_link1b_remote}_remote_client_25003.out &
    #numactl -C ${CLIENT_IFACE0_REMOTE_PIN} iperf3 --client ${ip_addr_link1b_local} --interval 10 --bind ${ip_addr_link1b_remote} --time ${RUNTIME} --len=128K --port 25004 -Z >${ip_addr_link1b_remote}_remote_client_25004.out &
    #numactl -C ${CLIENT_IFACE0_REMOTE_PIN} iperf3 --client ${ip_addr_link1b_local} --interval 10 --bind ${ip_addr_link1b_remote} --time ${RUNTIME} --len=128K --port 25005 -Z >${ip_addr_link1b_remote}_remote_client_25005.out &
    #numactl -C ${CLIENT_IFACE0_REMOTE_PIN} iperf3 --client ${ip_addr_link1b_local} --interval 10 --bind ${ip_addr_link1b_remote} --time ${RUNTIME} --len=128K --port 25006 -Z >${ip_addr_link1b_remote}_remote_client_25006.out &
    #numactl -C ${CLIENT_IFACE0_REMOTE_PIN} iperf3 --client ${ip_addr_link1b_local} --interval 10 --bind ${ip_addr_link1b_remote} --time ${RUNTIME} --len=128K --port 25007 -Z >${ip_addr_link1b_remote}_remote_client_25007.out &
    '" &
